  ...
  return (
    <div className="relative">
      <div
        ...
        className={`flex flex-row w-full p-1 justify-between h-16 md:h-[72px] lg:h-20 hover:bg-slate-100 ${playingMusic.id == music.id ? "bg-slate-200" : ""} rounded-xl cursor-pointer`}>
        <div className="flex flex-row items-center w-full sm:max-w-80 sm:min-w-80 lg:min-w-[28rem] lg:max-w-[28rem] gap-1">
          ...
          <div className="flex flex-col xsm:gap-1 h-full max-w-full overflow-hidden items-start">
            ...
            <span className="w-full text-sm text-dark-glassy font-semibold flex flex-row gap-1">
        ...
        <div className="flex flex-row items-center justify-center h-full w-auto gap-2 xsm:gap-3 pr-1 xsm:pr-2">
          <Icon
